...
export const Button: React.FC<ButtonProps> = ({
  ...
  // Generate a unique ID for the loading indicator
  const loadingId = loading ? `loading-${Math.random().toString(36).substr(2, 9)}` : undefined;
  ...
  return (
    ...
    >
      {loading && (
        ...
        >
          <title>Loading</title>
          <desc>Loading indicator animation</desc>
